...
useEffect(()=>{
  fetchannouncement({ _id: "659d320c4cd4bcca1ce2d7c8" });
...
const fetchannouncement = async (e) => {
  try {
    ...
    const url = (teacher) ? `http://localhost:5000/teacher/viewAnnouncements/${e._id}` : `http://localhost:5000/student/viewAnnouncements/${e._id}`;  
