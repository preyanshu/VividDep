  ...
  <option value="3">Parent</option>
            ...
            {type=="1" && <div className="mb-3 d-flex type1box" style={{justifyContent:"space-between"}}>
                ...
                <div style={{}}> 
                    ...
                    <input type="number" className="form-control" value={credentials.section} onChange={onChange} id="section" name="section" aria-describedby="emailHelp" max={8} />
               </div>
                <div style={{}}> 
                    <label htmlFor="name" className="form-label"><b>Semester :</b></label>
                    <input type="text" className="form-control" value={credentials.semester} onChange={onChange} id="semester" name="semester" aria-describedby="emailHelp"  max={1}/>
               </div>
                <div style={{}}> 
