...
return(
   <div className='mainbg'>
    ...
    <div className="bg" style={{width:desiredWidth2,transition:"0.3s"}}>
    ...
    >Logout</span></div></div>
        ...
        <div className="a shadow" style={{height:90+"px",width:24+"vw",backgroundColor:"white",borderRadius:13+"px"}}>
           ...
           <div style={{marginLeft:65+"%",marginTop:-8+"%"}}><h6>Today's Money</h6>
            <h4 style={{marginLeft:39.8+"%"}}><b>$53k</b></h4></div> 
        </div>
        ...
        <div style={{marginLeft:65+"%",marginTop:-8+"%",border:"0px solid black"}}><h6>Today's Users</h6>
        ...
        <div style={{marginLeft:65+"%",marginTop:-8+"%"}}><h6>Today's Money</h6>
            <h4 style={{marginLeft:39.8+"%"}}><b>$13k</b></h4></div> 
        </div>
